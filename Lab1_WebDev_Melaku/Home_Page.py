...
st.header("CS 1301")
st.subheader("Web Development - Section FAC")
st.subheader("Eyoel Melaku")
...
1.Portfolio: A page about my background, skills, and projects.
2.Quiz: A short interactive quiz to test your knowledge.
3.
4.
